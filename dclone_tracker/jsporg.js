...
const D2JSP_FETCH_INTERVAL_SECONDS = 60;
const D2JSP_TOGGLE_STORAGE_KEY = 'jsp';
const D2JSP_SEARCH_KEYWORD = 'DClone';
 ...
 */
async function fetchD2jspForumPage() {
 ...
 */
async function setD2jspToggle(toggleValue) {
